...
angular.module('clotho.dna').service('DNA', [function() {
...
angular.module('clotho.dna').directive('dnaShuffle', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
angular.module('clotho.dna').directive('dnaRandom', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaReverse', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaComplement', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaRevcomp', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaTranscribe', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaReverseTranscribe', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaTranslate', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaReverseTranslate', ['DNA', '$parse', function(DNA, $parse) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaDnaOnly', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaRemoveNonLetters', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaAminoOneToThree', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaAminoOneToFull', ['DNA', function(DNA) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaGcContent', ['DNA', '$filter', function(DNA, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaMeltingTemp', ['DNA', '$filter', function(DNA, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
angular.module('clotho.dna').directive('dnaMolecularWeight', ['DNA', '$filter', function(DNA, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
