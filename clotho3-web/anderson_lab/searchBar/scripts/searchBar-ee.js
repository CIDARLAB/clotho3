            ...
            if (hasInfoPane) {
                ...
                if (item.infoPane.hasOwnProperty('infoContent')) {
                    ...
                    for (key in item.infoPane.infoContent) {
                        ...
                        infoBlockHeaders += "<a class='infoBlockHeaderButton author'><img class='authorAvatar' alt='' src='" + item.infoPane.infoContent[i].header.author.avatar + "' /><span>Author:</span>" + item.infoPane.infoContent[i].header.author.linkText + "</a>";
                    ...
                    var infoBlockContent = "<div id='blockContent'>";
            ...
            $.ajax(
                {
                    ...
                    var $blockContent =  $("#blockContent");
                        $blockContent.fadeOut('slow', function () {
                            ...
                            $blockContent.find('.infoBlockContentBody').html("<p class='timeout'><span class='alert'></span>The system is taking longer than expected to respond. Please try again in a few minutes.'</p>");
                            $blockContent.fadeIn('slow');
                        });
                    } // end error
                });
