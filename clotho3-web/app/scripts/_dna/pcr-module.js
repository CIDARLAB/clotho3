...
angular.module('clotho.dna').service('PCR', ['DNA', 'Digest', function(DNA, Digest) {
...
angular.module('clotho.dna').directive('pcrPredict', ['PCR', 'Digest', 'DNA', function(PCR, Digest, DNA) {
...
angular.module('clotho.dna').directive('pcrAlign', ['PCR', 'Digest', 'DNA', '$filter', function(PCR, Digest, DNA, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
...
angular.module('clotho.dna').directive('ligateAlign', ['PCR', 'Digest', 'DNA', '$compile', '$filter', function(PCR, Digest, DNA, $compile, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
...
angular.module('clotho.dna').directive('ligateFrag', function() {
    return {
        restrict: 'EA',
        replace: false,
        transclude:true,
...
angular.module('clotho.dna').directive('ligateStickymatch', function() {
    return {
        restrict: 'EA',
        replace: false,
        transclude:true,
...
angular.module('clotho.dna').directive('ligateBluntmatch', function() {
    return {
        restrict: 'EA',
        replace: false,
        transclude:true,
