...
angular.module('clotho.dna').service('Digest', ['DNA', function(DNA) {
...
angular.module('clotho.dna').directive('digestMark', ['Digest', '$filter', '$parse', function(Digest, $filter, $parse) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
angular.module('clotho.dna').directive('digestHighlight', ['Digest', '$parse', '$compile', '$filter', function(Digest, $parse, $compile, $filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
angular.module('clotho.dna').directive('digestAnnotation', ['$tooltip', function($tooltip) {
    return {
        restrict : 'EA',
        replace: false,
        transclude:true,
...
angular.module('clotho.dna').directive('digestCutTop', [function() {
    return {
        restrict : 'EA',
...
angular.module('clotho.dna').directive('digestCutBottom', [function() {
    return {
        restrict : 'EA',
        link: function (scope, element, attrs) {
            element.html('&#8593;');
...
angular.module('clotho.dna').filter('DigestCuts', function() {
