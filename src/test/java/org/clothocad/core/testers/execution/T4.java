...
public class T4 {
    ...
    public static void setUpClass() {
        ...
        makeNBuddies = new Function("makeNBuddies", new String[]{"n","person"}, new Class[]{Integer.class, Person.class}, new Class[]{List.class},
        ...
        make1000Buddies = new Function("make1000Buddies", new String[]{"input"}, new Class[]{Person.class}, new Class[]{List.class},
        ...
        pyMakeBuddy = new Function("pyMakeBuddy", new String[]{"input"}, new Class[]{Person.class}, new Class[]{Person.class},
        ...
        pyMakeNBuddies = new Function("pyMakeNBuddies", new String[]{"n","person"}, new Class[]{Integer.class, Person.class}, new Class[]{List.class},
    ...
    @Before
    public void setUp(){
        makeBuddy = new Function("makeBuddy", new String[]{"input"}, new Class[]{Person.class}, new Class[]{Person.class},
    ...
    public void testGettersAndSettersAsProperty() throws ScriptException {
        ...
        Function f = new Function("testProperties", new String[]{"input"}, new Class[]{ScriptTestObject.class}, new Class[]{String.class}, 
