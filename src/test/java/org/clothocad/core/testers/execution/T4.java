...
public class T4 {
    ...
    public static void setUpClass() {
        ...
        makeNBuddies = new Function("makeNBuddies", new Argument[]{new Argument("n", Integer.class), new Argument("person", Person.class)}, List.class,
        ...
        make1000Buddies = new Function("make1000Buddies", new Argument[]{new Argument("person", Person.class)}, List.class,
        ...
        pyMakeBuddy = new Function("pyMakeBuddy", new Argument[]{new Argument("input", Person.class)}, Person.class,
        ...
        pyMakeNBuddies = new Function("pyMakeNBuddies", new Argument[]{new Argument("n", Integer.class), new Argument("person", Person.class)}, List.class,
    ...
    @Before
    public void setUp(){
        makeBuddy = new Function("makeBuddy", new Argument[]{new Argument("input", Person.class)}, Person.class,
    ...
    public void testGettersAndSettersAsProperty() throws ScriptException {
        ...
        Function f = new Function("testProperties", new Argument[]{new Argument("input", ScriptTestObject.class)}, String.class, 
